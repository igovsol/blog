...
Don't waste your budget on unnecessary production support for something not yet in production. Use your budget to develop your graph solution.  We would be happy to help you build a solution if you need help.
...
This instantly made the pricing information 'public domain' which is why I can post this information. 
