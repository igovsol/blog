...
Only Neo4j Inc can answer these questions, and I feel they have some explaining to do to the open source community.
...
Many federal agencies have already invested in the adoption and use of Neo4j Enterprise using it’s free open source license. Luckily, we happen to be Neo4j developers and these moves simply do not affect us or our federal clients because we build the binaries from source already.
